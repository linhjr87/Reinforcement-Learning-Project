...
class Vasuki:
    ...
    def __init__(self, n, rewards, game_length=100):
        ...
        # Loading the Images
        self.image_agentA = self._init_image_(os.path.join(ASSETS_DIR, "agentA.png"))
        self.image_agentB = self._init_image_(os.path.join(ASSETS_DIR, "agentB.png"))
        self.image_prey = self._init_image_(os.path.join(ASSETS_DIR, "prey.png"))
        # Creating History
